  ...
  return (
    <Container>
      ...
      <Post>
        ...
        <li>Integrated API, and written clean and reusable codes.</li>
        <li>Supported system integration testing and user acceptance testing.</li>
        ...
        <li>Led a team of 3, architected solutions, developed, documented, and pitched final products.</li>
        ...
        <li>Managed projects using GitHub, Trello with Kanban board, and Microsoft Teams Planner.</li>
        ...
        <li>Led a team of 13 to provide résumé writing tips & tricks to 80+ INTI students to increase employability.</li>
        <li>Professionally produced two{" "}
          <a href="https://www.facebook.com/intiiu.cs/videos" rel="noopener noreferrer" target="_blank">Career Fair videos</a> 
          {" "}and five{" "}
          <a href="https://www.facebook.com/intiiu.cs/videos" rel="noopener noreferrer" target="_blank">interview videos</a> 
          {" "}using Adobe Premiere Pro.
        </li>
        <li>Professionally supported in designing three{" "}
          <a href="https://www.facebook.com/intiiu.cs/photos" rel="noopener noreferrer" target="_blank">Career Fair posters</a> 
          {" "}using Photoshop.
        </li>
        ...
        <table>
          ...
          <tr>
            ...
            <td>
              ...
              <li>Tech stack: HTML, CSS, SQL, PHP, Bootstrap, phpMyAdmin, PhpStorm.</li>
