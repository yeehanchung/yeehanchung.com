  ...
  return (
    <Container>
      ...
      <Content>
        ...
        <br />
        <P lineHeight="medium">
          Hello there, I'm a software engineer. Passionate in bringing my ideas to life to make life easier. Currently located at Petaling Jaya, Selangor, Malaysia, and originally from East Malaysia, Sandakan, Sabah.
        </P>
        <br/>
        <P lineHeight="medium">
