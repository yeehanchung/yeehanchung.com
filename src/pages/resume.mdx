...
<!-- 
- Automate test cases of multiple external and internal platforms to improve site-reliability, and visibility for stakeholders using UI-licious tool.
- Tech stack: JavaScript, CSS/XPATH
-->
...
- Supported UAT (User Acceptance Testing) & SIT (System Integration Testing).
