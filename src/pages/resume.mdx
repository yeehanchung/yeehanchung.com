...
-	Tech stack of [E-commerce](http://www.sausagekl.com/): **React.js**, **Redux**, **CSS/SCSS**, **Git**, **Google Firestore**, **Google Analytics**, **Heroku**.
-	Tech stack of [Blog](https://blog.sausagekl.com/): **Gatsby.js**, **GraphQL**, **CSS/SCSS**, **Git**, **Google Analytics**, **Netlify**.
...
- Tech stack of [Blog](https://yeehan.dev/): **Gatsby.js**, **GraphQL**, **CSS/SCSS**, **Git**, **Markdown**, **Google Analytics**, **Netlify**.
